...
options.sass = {
    ...
    includePaths: [
        ...
        options.rootPath.project + 'libraries/font-awesome/scss',
    ],
...
// GC changed to run everything through init/styles
...
gulp.task('develop', ['browser-sync', 'watch:css']);
