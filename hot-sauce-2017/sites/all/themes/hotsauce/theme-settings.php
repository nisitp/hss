 ...
 */
function hotsauce_form_system_theme_settings_alter(&$form, &$form_state, $form_id = NULL) {
  ...
  $form['hotsauce_example'] = array(
  '#type'          => 'checkbox',
  '#title'         => t('hotsauce sample setting'),
  '#default_value' => theme_get_setting('hotsauce_example'),
